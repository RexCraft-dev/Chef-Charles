...
from src.Buttons import HoverButton
...
class GroceryFrame(Frame):
    def __init__(self, master, **kwargs):
        ...
        btn_new = HoverButton(frame_buttons,
                                   borderwidth=0,
                                   highlightthickness=2,
                                   relief='flat',
                                   foreground='white',
        ...
        btn_open = HoverButton(frame_buttons,
                                   borderwidth=0,
                                   highlightthickness=2,
                                   relief='flat',
                                   foreground='white',
        ...
        btn_save = HoverButton(frame_buttons,
                                   borderwidth=0,
                                   highlightthickness=2,
                                   relief='flat',
                                   foreground='white',
        ...
        btn_delete = HoverButton(frame_buttons,
                                   borderwidth=0,
                                   highlightthickness=2,
                                   relief='flat',
                                   foreground='white',
        ...
        frame_view.grid(row=0, column=1, rowspan=4)

        grocery_list = tk.Text(frame_view, height=60)
        grocery_list.pack()
